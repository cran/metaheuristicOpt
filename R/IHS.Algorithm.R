...
#'
#' Harmony Search (HS)  was proposed by Geem, Zong Woo, Joong Hoon Kim, and G. V. 
#' Loganathan in 2001, mimicking the improvisation of music players. Furthermore, 
...
#'
#' @param PAR a positive integer to determine the value of Pinch Adjusting Ratio.
#'
#' @param HMCR a positive integer to determine the Harmony Memory Consideration Rate.
#'
#' @param bandwith a positive integer to determine the bandwith.
#'
